...
su docker -c 'pacaur -m --noprogressbar --noedit --noconfirm nextcloud-testing'
pacman -U --noconfirm --needed /home/docker/.cache/pacaur/nextcloud/nextcloud-testing-${NC_VERSION}-any.pkg.tar
